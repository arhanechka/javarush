...
/* Общий список
1. Изменить класс Solution2 так, чтобы он стал списком. (Необходимо реализовать интерфейс java.util.List).
2. Список Solution2 должен работать только с целыми числами Long.
